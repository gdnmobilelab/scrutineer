...
create table notification_modifications (
    ...
    line3 VARCHAR(500),
    line4 VARCHAR(500),
    iOSCollapsed1 VARCHAR(500),
    iOSCollapsed2 VARCHAR(500),
    androidCollapsed1 VARCHAR(500),
    clinton_avatar VARCHAR(2500),
    trump_avatar VARCHAR(2500),
...
create table sent_notifications (
    ...
    notification_data_json JSON NOT NULL,
